...
<head>
	...
	<title> Stok Produk - Grow Guard </title>
	...
	<div class="ADMIN">
		<nav class="navbar navbar-expand-md navbar-light bg-light">
			...
			<div class="TABEL_PRODUK">
				<div class="judul">
						<br><br>
						<h2 class="text-center m" style="font-family: 'Cinzel Decorative', sans-serif;"> STOK PRODUK </h2>
				</div>
				...
				<div class="cek_stok">
					<a href="AdminGG.php" tabindex="-1" role="button" aria-disabled="true"><button type="button" class="btn btn-success mt-auto p-2" style="margin-left: 1370px; font-family: 'Raleway', sans-serif;">Kembali</button></a>
				</div>
