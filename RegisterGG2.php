...
<head>
	...
	<title> Register Admin - Grow Guard </title>
...
<body style="background: whitesmoke; font-family: 'Raleway', sans-serif;">
	...
	<div class="container-login-register">
        <h2 style="text-align: center; padding-top:20px; padding-bottom: 20px;">Register</h2>
        ...
        <br>
        <p>Sudah punya akun? <a href="LoginGG2.php">Login disini</a></p>
    </div>
    <br> <br>
